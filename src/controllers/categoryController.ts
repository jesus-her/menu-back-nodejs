...
export const getAllCategories = async (req: Request, res: Response): Promise<void> => {
    try {
        ...
        res.status(500).json({ error: 'Hubo un error al obtener las categorías, pruebe más tarde' });
    }
};
...
export const getCategoryById = async (req: Request, res: Response): Promise<void> => {
    try {
        ...
        res.status(500).json({ error: 'Hubo un error al obtener la categoría, pruebe más tarde' });
    }
};
...
export const updateCategory = async (req: Request, res: Response): Promise<void> => {
    ...
    try {
        ...
        res.status(500).json({ error: 'Hubo un error al actualizar la categoría, pruebe más tarde' });
    }
};
...
export const deleteCategory = async (req: Request, res: Response): Promise<void> => {
    ...
    try {
        ...
        res.status(500).json({ error: 'Hubo un error al eliminar la categoría, pruebe más tarde' });
    }
};
